...
picard MarkDuplicates OPTICAL_DUPLICATE_PIXEL_DISTANCE=12000 I=$BAM o=$out REMOVE_DUPLICATES=false METRICS_FILE=$metrics TAGGING_POLICY=All VALIDATION_STRATEG
Y=LENIENT
