...
### samtools depth -a -Q 30 -q 20 -b /mnt/shared/scratch/rmacleod/private/shamanka2/EBA_hg19/bams/1240K_positions.bed ${FILES[$SLURM_ARRAY_TASK_ID]} | datamash mean 3 > ${FILES[$SLURM_ARRAY_TASK_ID]}.autodepth.txt
